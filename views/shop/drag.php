...
<!--
var pic = new Image();
pic.src="<?php echo lib_functions::image_src('shop/arrow_right.gif');?>";
...
function toggleMenu()
{
  ...
  {
    frmBody.cols="200, 10, *";
    imgArrow.src = "<?php echo lib_functions::image_src('shop/arrow_left.gif');?>";
  }
  else
  {
    frmBody.cols="0, 10, *";
    imgArrow.src = "<?php echo lib_functions::image_src('shop/arrow_right.gif');?>";
  }
}
...
<table height="100%" cellspacing="0" cellpadding="0" id="tbl">
  ...
  <?php echo lib_functions::image('shop/arrow_left.gif',array('id'=>'img','width'=>'10','height'=>'30','border'=>0));?>
	</a>
  </td></tr>
</table>
</body>
